//Apenas vazio por enquanto pois vai ser praticamente o mesmo do addItem.js
// A diferença será de apenas algumas modificações e adições então será necessário ter a outra parte primeiro

import React, { useState } from 'react';
import { View, Text, TextInput, StyleSheet, Image, TouchableOpacity, StatusBar, TouchableHighlight, FlatList } from 'react-native';
    ...
    <SafeAreaProvider style={styles.container}>
      <SafeAreaView>
        ...
        <View style={headerStyles.header}>
          ...
          <Text style={headerStyles.headerTitle}>Editar Item</Text>
